...
import com.doit.app.mapper.ContentMapper;
...
public class ContentServiceImpl implements ContentService {
     ...
     */
    @Override
    public ContentVO getContentDetail(Long contentId, Long memberNo) {
     ...
     */
    @Override
    public boolean toggleBookmark(Long memberNo, Long contentId) {
        if (mapper.countBookmark(memberNo, contentId) > 0) {
            mapper.deleteBookmark(memberNo, contentId);
            return false;
        }
        mapper.insertBookmark(memberNo, contentId);
        return true;
    }
